...
`recentchanges query` has tkinter database viewer https://forum.porteus.org/go.php?https://drive.google.com/file/d/1IfC8x5G_c80hMTbezKU_DarK45XsqbwY/view?usp=sharing <br>
Commands:<br>
save-changesnew<br>
recentchanges
