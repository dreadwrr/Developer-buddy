...
also a shortcut rnt to inverse. recentchanges search it normally doesnt apply the filter but now it will. for a newer than file search with rnt search myfile it will remove the filter as that is normally filtered.<br><br>
