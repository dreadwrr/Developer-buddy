...
script includes recentchanges as well as save-changesnew. There is now only the bash (default uses a python backend) being the main version. A special edition py ver will be available
