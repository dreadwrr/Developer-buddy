...
I first started a Qt gui for Windows 10/11 based on recent changes. Then converted it to work with linux. Afterwards went back and updated the initial windows release. 
