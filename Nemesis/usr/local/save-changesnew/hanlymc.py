...
def hanly(parsed_chunk, checksum, cdiag, dbopt, ps, usr, logging_values, id_to_mime, cachermPATTERNS, logger=None):
        ...
        with conn:
            ...
            for record in parsed_chunk:
                ...
                if ps and recent_sys and len(recent_sys) > 16:
                    ...
                    emit_log("DEBUG", f"recent sys entry less than required length 16 : {recent_sys}", logs.WORKER_LOG_Q, logger=logger)
